...
public class StickersProvider extends BaseContentProvider {
    ...
    private static final int URI_TYPE_RECENTLY_STICKERS = 4;
    private static final int URI_TYPE_RECENTLY_STICKERS_ID = 5;

    private static final int URI_TYPE_STICKERS = 6;
    private static final int URI_TYPE_STICKERS_ID = 7;
