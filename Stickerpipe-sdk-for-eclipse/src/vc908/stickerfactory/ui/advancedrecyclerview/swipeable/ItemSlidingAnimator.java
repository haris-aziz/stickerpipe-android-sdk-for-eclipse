...
public class ItemSlidingAnimator {
    ...
    public void slideToSpecifiedPosition(RecyclerView.ViewHolder holder, float position) {
        slideToSpecifiedPosition(holder, position, false);
    }
    public void slideToSpecifiedPosition(RecyclerView.ViewHolder holder, float position, boolean shouldAnimate) {
        cancelDeferredProcess(holder);
        slideToSpecifiedPositionInternal(holder, position, shouldAnimate, 200);
    }
    ...
    public void setAdditionAnimatorListener(ViewPropertyAnimatorListener listener){
