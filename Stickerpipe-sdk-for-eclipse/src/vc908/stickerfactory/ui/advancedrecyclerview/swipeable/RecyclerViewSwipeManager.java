...
import vc908.stickerfactory.ui.advancedrecyclerview.utils.CustomRecyclerViewUtils;
...
public class RecyclerViewSwipeManager {
     ...
     * {@link SwipeableItemAdapter#onPerformAfterSwipeReaction(RecyclerView.ViewHolder, int, int, int)} method.
     *
     ...
     * {@link SwipeableItemAdapter#onGetSwipeReactionType(RecyclerView.ViewHolder, int, int, int)} method.
     *
     ...
     * {@link SwipeableItemAdapter#onSetSwipeBackground(RecyclerView.ViewHolder, int, int)} method.
     *
    ...
    private void slideItem(RecyclerView.ViewHolder holder, float amount, boolean shouldAnimate) {
        if (amount == OUTSIDE_OF_THE_WINDOW_LEFT) {
            ...
            mItemSlideAnimator.slideToSpecifiedPosition(holder, amount, shouldAnimate);
        }
    }
    ...
    public void setAdditionItemAnimatorListener(ViewPropertyAnimatorListener listener){
        if(mItemSlideAnimator != null){
            mItemSlideAnimator.setAdditionAnimatorListener(listener);
        }
    }
}
